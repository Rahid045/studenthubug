...
?>
<!doctype html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Resources | Student hub ug</title><link rel="stylesheet" href="style.css"></head><body>
<header class="site-header"><div class="container nav"><a class="logo" href="index.html"><span class="logo-mark">S</span>Student hub ug</a><ul class="nav-links"><li><a href="index.html">Home</a></li><li><a class="active" href="resources.php">Resources</a></li><li><a href="tutoring.php">Tutoring</a></li></ul><div class="nav-actions"><?php if(isset($_SESSION['user_id'])):?><a class="btn btn-soft" href="dashboard.php">Dashboard</a><?php if(($_SESSION['role'] ?? 'student') === 'admin'):?><a class="btn btn-primary" href="upload.php">Upload</a><?php endif;?><?php else:?><a class="btn btn-soft" href="login.html">Sign in</a><a class="btn btn-primary" href="register.html">Join free</a><?php endif;?></div></div></header>
